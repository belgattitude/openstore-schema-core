...
file_put_contents("$doc_directory/create_schema_utf8.sql", $ddl);

$ddl_utf8mb4 = preg_replace('/ utf8 /i', ' utf8mb4 ', $ddl);
...
$ddl_utf8mb4 = preg_replace('/ utf8_ge_ci /i', ' utf8mb4_unicode_ci ', $ddl_utf8mb4);
file_put_contents("$doc_directory/create_schema_utf8mb4.sql", $ddl_utf8mb4);
...
file_put_contents("$doc_directory/create_schema_extra_utf8.sql", $extra_ddl);

$extra_ddl_utf8mb4 = preg_replace('/ utf8 /i', ' utf8mb4 ', $extra_ddl);

$extra_ddl_utf8mb4 = preg_replace('/ utf8_ge_ci /i', ' utf8mb4_unicode_ci ', $extra_ddl_utf8mb4);
file_put_contents("$doc_directory/create_schema_extra_utf8mb4.sql", $extra_ddl_utf8mb4);
