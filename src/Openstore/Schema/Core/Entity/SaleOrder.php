...
/**
 * @ORM\Entity(repositoryClass="Openstore\Schema\Core\Entity\Repository\SaleOrderRepository")
 * @ORM\Table(
 *   name="sale_order",
 *   uniqueConstraints={
...
class SaleOrder
{
    ...
    {
        //$customer = ->getRepository('Openstore\Schema\Core\Entity\Customer')->find($customer_id);
